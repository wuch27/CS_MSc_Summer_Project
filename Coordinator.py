	...
	def run(self):
		...
		while not self.__keepRunning():
			...
			# There wasn't anything
				...
				self.__logging_manager.logInfo(__file__, f"Waited {self.__check_wait_time}s for new file.")
	...
	def __processFile(self, filepath, camera_ID, timestamp):
		...
		while video.isOpened():
			...
			if ret:
				...
				if observations.getProcessQueueLength() == cfg.DET.BATCH_SIZE:
...
if __name__ == '__main__':
	...
	# Let's initialise everything as necessary
